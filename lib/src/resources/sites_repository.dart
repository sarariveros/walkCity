...
class SiteRepository {
  ...
  static List<Site> museos = [
    Site(
        id: 7,
        categoria: 'Museos',
        nombre: 'Museo Principal de Ayacucho',
        imagen:
    ...
    Site(
        id: 9,
        categoria: 'Museos',
        nombre: 'Museo Monumental de Ayacucho',
        imagen:
